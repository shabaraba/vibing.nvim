...
`nvim_get_buffer`. The workflow is the bundled `claude-plugin/skills/vibing-orchestrate/SKILL.md`; there is no
...
(`claude-plugin/skills/vibing-worktree-*`), not through a vibing.nvim chat command. There is no bespoke
...
worktree across turns. See `claude-plugin/skills/vibing-worktree-list/SKILL.md` (and its sibling `-create`,
