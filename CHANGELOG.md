...
- **Project-local Codex permission profiles.** vibing.nvim creates
  ...
  Set `permissions.codex_profile_file = false` to disable loading it.
...
* fix: register the markdown treesitter parser for the vibing filetype by @shabaraba in https://github.com/shabaraba/vibing.nvim/pull/605
* feat: make :VibingSummarize write a decision log, not a work log by @shabaraba in https://github.com/shabaraba/vibing.nvim/pull/604


**Full Changelog**: https://github.com/shabaraba/vibing.nvim/compare/v5.3.1...v5.4.0
...
- fix: improve daily summary search_dirs and mtime handling by @shabaraba in https://github.com/shabaraba/vibing.nvim/pull/388

**Full Changelog**: https://github.com/shabaraba/vibing.nvim/compare/v1.31.0...v1.31.1
...
**Full Changelog**: https://github.com/shabaraba/vibing.nvim/compare/v1.25.0...v1.26.0
