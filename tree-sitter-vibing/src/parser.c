...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [STATE(2)] = {
    ...
    [aux_sym_markdown_line_token1] = ACTIONS(11),
    [aux_sym_markdown_line_token2] = ACTIONS(11),
    [sym_fenced_markdown_block] = ACTIONS(15),
  },
  [STATE(3)] = {
    [sym_tool_block] = STATE(3),
    [sym_markdown_chunk] = STATE(3),
    ...
    [sym_fenced_markdown_block] = ACTIONS(19),
  },
};
...
extern "C" {
#endif
void *tree_sitter_vibing_external_scanner_create(void);
void tree_sitter_vibing_external_scanner_destroy(void *);
bool tree_sitter_vibing_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_vibing_external_scanner_serialize(void *, char *);
void tree_sitter_vibing_external_scanner_deserialize(void *, const char *, unsigned);
...
TS_PUBLIC const TSLanguage *tree_sitter_vibing(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_vibing_external_scanner_create,
      tree_sitter_vibing_external_scanner_destroy,
      tree_sitter_vibing_external_scanner_scan,
      tree_sitter_vibing_external_scanner_serialize,
      tree_sitter_vibing_external_scanner_deserialize,
    },
