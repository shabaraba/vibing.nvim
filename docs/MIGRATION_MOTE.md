...
**Solution:** Initialize mote in your project:
...
**Solution:** Make changes to the file, or manually create a snapshot:

```bash
mote --storage-dir .vibing/mote snapshot -m "Manual snapshot"
```
